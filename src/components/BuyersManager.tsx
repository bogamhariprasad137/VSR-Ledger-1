...
export default function BuyersManager({
  ...
  return (
    <div className="w-full max-w-7xl mx-auto">
      ...
      <div className={`col-span-12 ${selectedBuyerId || isAdding || isEditing ? "md:col-span-8" : "md:col-span-12 hidden md:flex"} glass-card rounded-2xl p-4 md:p-6 flex flex-col min-h-[500px]`}>
